...
function correctAns(finishedDiv, nextDivOne, nextDivTwo) {
    ...
    ans.style.background= 'url(../Front-Enter/image/checked-FFD800.svg)';
...
function wrongAns(el) {
    ...
    app.get(el).style.background= 'url(../Front-Enter/image/cancel-FC4803.svg)';
...
app.get('.icon-one').addEventListener('click', function() {
    app.get('.user-icon').style.background = 'url(../Front-Enter/image/cute.svg) left center / contain no-repeat';
    app.get('.icon-outside').style.display = 'none';
})
app.get('.icon-two').addEventListener('click', function() {
    app.get('.user-icon').style.background = 'url(../Front-Enter/image/cute2.svg) left center / contain no-repeat';
    app.get('.icon-outside').style.display = 'none';
})
app.get('.icon-three').addEventListener('click', function() {
    app.get('.user-icon').style.background = 'url(../Front-Enter/image/cute3.svg) left center / contain no-repeat';
    app.get('.icon-outside').style.display = 'none';
})